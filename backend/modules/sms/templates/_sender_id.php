...
<div class="row justify-content-between">
    <div class="col-md-8">
        <label class="control-label" for="bookly-sender-id-input"><?php esc_html_e( 'Request Sender ID', 'bookly' ) ?></label> <?php if ( $sms->getSenderIdApprovalDate() ) : ?> <span class="bookly-vertical-middle"><?php _e( 'or', 'bookly' ) ?> <a href="#" id="bookly-reset-sender_id"><?php esc_html_e( 'Reset to default', 'bookly' ) ?></a></span><?php endif ?>
        <form class="form-row">
